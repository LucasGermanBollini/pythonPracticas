...
ladoA = int(input("Ingresa la medida del primer lado: "))
ladoB = int(input("Ingresa la medida del segundo lado: "))
ladoC = int(input("Ingresa la medida del tercer lado: "))
if ladoA < (ladoB + ladoC) and ladoB < (ladoA + ladoC) and ladoC < (ladoA + ladoB):
    print("Los datos forman un triangulo.")
    ...
    print("Los datos no forman un triangulo.")
